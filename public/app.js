...
async function sendToGooglePhotos() {
    ...
    if (navigator.share) {
        ...
        alert("이 브라우저는 자동 공유를 지원하지 않습니다. 그림을 저장!");
        var link = document.createElement('a');
        link.href = dataUrl;
        link.download = 'AiNoteX_Work.png';
        link.click();
...
// 4. 페이지가 로드될 때와 0.5초 뒤에 한 번 더 실행해서 확실히 글자를 .
